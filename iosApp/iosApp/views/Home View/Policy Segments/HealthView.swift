...
struct HealthView: View {
    ...
    @State private var searchText: String = "" // State for search tex
    ...
    var body: some View {
        VStack(spacing:0){
            ...
            .onAppear{
                ...
                getSlabTypeByPolicySegments(segmentId: "3b554917-a340-4682-9eac-3ffe13ec660f")
            ...
            VStack(spacing:0){
                ...
                Button {
                    let payload = GeneralPolicyRatePayload(
                        ...
                        slab_id: submittingValue["Slab"] ?? "",
                        product_id: submittingValue["Product"] ?? "",
        ...
        .onReceive(accessModel.$insurerByGroupId, perform: {value in
            if !value.isEmpty {
                self.insurerList = value
            }
            else {
                self.insurerList = []
            }
