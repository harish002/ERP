package com.chp.erp.android.ui.component
...
import com.chp.erp.android.ui.screens.auth.ERValidation
...
//                            isLoading = false // Stop loading after getting the response
        ...
        if (value.isNotBlank() && !isValid && isSignUp) {
                ...
                "Username" -> {
                                if (!ERValidation().isValidUsername(value)) {
                                    "Invalid Format"
                ...
                "Email ID" ->{
                                if (!ERValidation().isValidEmail(value)) {
                ...
                "Phone Number"  -> {
                                if (!ERValidation().isValidNumber(value)) {
                                    "Invalid Number"
