...
import com.policy.lms.Services.Dataclass.RefreshToken
...
import com.policy.lms.Services.Dataclass.SearchPolicyRateData
...
import com.policy.lms.Services.Dataclass.UserResponse
...
//            val responseBody = response.body<String>()
    ...
    @Throws(IOException::class, CancellationException::class)
    suspend fun getVehicleBrands(token: String): VehicleBrands {
        try {
            val response: HttpResponse = client.get {
